# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-21 00:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='hello.Customer')),
                ('items', models.ManyToManyField(through='hello.Order_Items', to='hello.Product')),
            ],
        ),
        migrations.CreateModel(
            name='Stock',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='hello.Supplier_Contact'),
        ),
        migrations.AddField(
            model_name='stock',
            name='warehouse',
